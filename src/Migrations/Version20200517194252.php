 ...
 */
final class Version20200517194252 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_44954CB70DF7698 ON category_tb');
        $this->addSql('DROP INDEX categorytb_parentfk ON category_tb');
        ...
        $this->addSql('CREATE INDEX categorytb_parentfk ON category_tb (id_parent_category)');
        ...
        $this->addSql('ALTER TABLE user_tb DROP register_date');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX categorytb_parentfk ON category_tb');
        $this->addSql('ALTER TABLE category_tb ADD CONSTRAINT id_parent_category FOREIGN KEY (id_parent_category) REFERENCES category_tb (id) ON UPDATE NO ACTION ON DELETE SET NULL');
        $this->addSql('CREATE INDEX IDX_44954CB70DF7698 ON category_tb (id_parent_category)');
        $this->addSql('CREATE INDEX categorytb_parentfk ON category_tb (id_parent_category, id)');
        ...
        $this->addSql('ALTER TABLE user_tb ADD register_date DATE DEFAULT \'CURRENT_TIMESTAMP\'');
    }
}
