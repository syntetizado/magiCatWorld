 ...
 */
final class Version20200517211701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category_tb CHANGE parent_slug id_parent_category INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category_tb CHANGE id_parent_category parent_slug INT DEFAULT NULL');
